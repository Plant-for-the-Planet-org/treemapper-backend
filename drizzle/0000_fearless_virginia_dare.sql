...
CREATE TYPE "public"."visibility" AS ENUM('public', 'private', 'organization');--> statement-breakpoint
...
ALTER TABLE "project_sites" ADD CONSTRAINT "project_sites_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_sites_slug_project_idx" ON "project_sites" USING btree ("project_id","slug");--> statement-breakpoint
...
CREATE INDEX "project_users_role_idx" ON "project_users" USING btree ("role");--> statement-breakpoint
...
CREATE INDEX "default_project_idx" ON "projects" USING btree ("created_by","is_default");--> statement-breakpoint
